...
public class StudentServiceImpl implements StudentService {
    ...
    private void checkIfExistToDelete(long studentId) throws NotExistException {
        if (!repository.existsById(studentId))
            throw new NotExistException("The Student with ID '" + studentId + "' not exist.");
    }

    private Group getGroupByNumber(StudentDto student) throws NotExistException {
    ...
    private Student getStudentFromDb(StudentDto student) throws NotExistException {
    ...
    private void updateStudentFieldsToSave(StudentDto student, Student studentFromDb) throws NotExistException {
        studentFromDb.setFirstName(student.getFirstName());
        studentFromDb.setLastName(student.getLastName());
        studentFromDb.setGroup(getGroupByNumber(student));
    }

    private Student setStudentFieldsToSave(StudentDto student) throws NotExistException {
