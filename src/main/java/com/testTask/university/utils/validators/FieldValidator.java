...
public class FieldValidator {
    ...
    public void validateCreateOrUpdateLecture(LectureDto lecture) throws WrongInputDataException {
    ...
    public void validateCreateOrUpdateStudent(StudentDto studentDto) throws WrongInputDataException {
    ...
    public void validateGroupNumber(int groupNumber) throws WrongInputDataException {
    ...
    public void validateAudienceNumber(int audienceNumber) throws WrongInputDataException {
    ...
    public void validateName(String firstName, String lastName) throws WrongInputDataException {
    ...
    public void validateLectureName(String lectureName) throws WrongInputDataException {
